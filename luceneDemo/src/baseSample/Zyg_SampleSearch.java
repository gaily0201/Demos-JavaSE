...
//	    Directory directory = FSDirectory.open("/path");
		Directory directory = FSDirectory.open(new File("c/lucene_test"));
		Analyzer analyzer = new StandardAnalyzer(Version.LUCENE_CURRENT);
		analyzer = new CJKAnalyzer(Version.LUCENE_CURRENT);
		//Now search the index
		IndexSearcher isearcher = new IndexSearcher(Zyg_IndexDocument.getIndexDirectory(directory, analyzer), true);
